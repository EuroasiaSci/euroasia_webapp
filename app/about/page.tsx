  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6" style={{color: '#48009f'}}>Unparalleled Excellence in Scientific Services</h2>
          <p className="text-lg text-neutral-700 leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6" style={{color: '#48009f'}}>Dedicated to Quality</h2>
          <p className="text-lg text-neutral-700 leading-relaxed">
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6" style={{color: '#48009f'}}>Innovation and Unmatched Support</h2>
          <p className="text-lg text-neutral-700 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="group bg-white rounded-xl p-8 border border-neutral-200 hover:border-primary hover:shadow-medium transition-all duration-300 hover:-translate-y-1 min-h-[280px] flex flex-col items-center text-center">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold" style={{color: '#48009f'}}>Our Mission</h3>
              </div>
...
trust in the marketplace.</p>
            ...
            <div className="group bg-white rounded-xl p-8 border border-neutral-200 hover:border-primary hover:shadow-medium transition-all duration-300 hover:-translate-y-1 min-h-[280px] flex flex-col items-center text-center">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold" style={{color: '#48009f'}}>Our Vision</h3>
              </div>
              <p className="text-neutral-600 leading-relaxed text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              style={{
                backgroundColor: activeCard === 'what-we-do' ? '#ab21a1' : 'white',
                color: activeCard === 'what-we-do' ? 'white' : '#ab21a1',
                borderColor: '#ab21a1'
              }}
              onMouseEnter={(e) => {
                if (activeCard !== 'what-we-do') {
                  e.currentTarget.style.backgroundColor = '#ab21a1';
              ...
              onMouseLeave={(e) => {
                if (activeCard !== 'what-we-do') {
                  ...
                  e.currentTarget.style.color = '#ab21a1';
                }
              }}
            >
              What We Do
            ...
            <button 
              ...
              style={{
                backgroundColor: activeCard === 'our-goal' ? '#ab21a1' : 'white',
                color: activeCard === 'our-goal' ? 'white' : '#ab21a1',
                borderColor: '#ab21a1'
              }}
              onMouseEnter={(e) => {
                if (activeCard !== 'our-goal') {
                  e.currentTarget.style.backgroundColor = '#ab21a1';
                  e.currentTarget.style.color = 'white';
                }
              }}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative lg:mr-8">
              <div className="relative h-96 rounded-xl overflow-hidden shadow-lg">
                <Image
                  src="/images/about_euroasia.jpeg" 
                  alt="EuroAsia Laboratory Excellence - Professional Testing Environment"
            ...
            <div className="relative lg:-ml-16 lg:z-10">
              <div className="group bg-white rounded-xl p-8 border border-neutral-200 hover:border-primary hover:shadow-medium transition-all duration-300 hover:-translate-y-1 h-[500px] flex flex-col">
                {activeCard === 'what-we-do' && (
                  <>
                    <h3 className="text-2xl font-bold text-gradient mb-6">What We Do</h3>
                ...
                {activeCard === 'our-goal' && (
                  <>
                    <h3 className="text-2xl font-bold text-gradient mb-6">Our Goal</h3>
