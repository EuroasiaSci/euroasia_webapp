    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-gradient-to-r from-primary/90 to-secondary/90 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl font-bold">Elevate Your Pharmaceutical Products with EuroAsia&apos;s Comprehensive Testing Services</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">
              We help you comply with the most important pharmaceutical regulations worldwide
            </p>
          </div>
