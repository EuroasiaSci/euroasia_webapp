  ...
  const features = [
    {
      ...
      description: "Our laboratory is ISO 17025 certified, ensuring the highest standards of testing accuracy and reliability for all our services."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "Expert Team",
      description: "Our team consists of highly qualified scientists and technicians with years of experience in various testing methodologies."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
            Why Choose <span className="text-gradient">EUROASIA</span>?
          </h2>
          <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
            We combine cutting-edge technology, expert knowledge, and unwavering commitment 
            to deliver laboratory testing services that exceed your expectations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 rounded-xl border border-neutral-200 hover:border-primary hover:shadow-medium transition-all duration-300 hover:-translate-y-1"
            >
